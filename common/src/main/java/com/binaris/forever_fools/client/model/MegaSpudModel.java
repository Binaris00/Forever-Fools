...
public class MegaSpudModel<T extends Entity> extends HierarchicalModel<T> {
    public static final ModelLayerLocation LAYER_OUTER_LOCATION = new ModelLayerLocation(FFCommonMod.id("megaspud"), "outer");
    public static final ModelLayerLocation LAYER_INNER_LOCATION = new ModelLayerLocation(FFCommonMod.id("megaspud"), "main");
